...
class PermissionService:
    ...
    async def update(self, permission_id: int, permission_data: dict) -> Optional[Permission]:
        """Update permission."""
    ...
    async def name_exists(self, name: str, exclude_permission_id: Optional[int] = None) -> bool:
